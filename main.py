...
if __name__ == "__main__":
    ...
    output_combined(output_dir="datasets/wordle++/", parts_of_speech=[["N"], ["V"], ["ADJ"]], output_pos_tags=False, inflections=False, check_inflections=True, regex=r'^[^\-\/\+\=\*\&\%\$\#\@\!\?\.\,\;\:\(\)\[\]\{\}\|\\\"\'\`\~\^\<\>\d\s]{2,8}$', outer_join=True)
